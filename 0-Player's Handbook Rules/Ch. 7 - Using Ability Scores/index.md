...
The "Minimum Roll Threshold" rule is being removed from the base game, treated now as a Variant Rule.
 All features that cite this rule will be adjusted on a case-by-case basis.
