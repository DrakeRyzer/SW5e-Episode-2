...
The "Minimum Roll Threshold" rule is being removed from the base game, treated now as a [Variant Rule](https://drakeryzer.github.io/SW5e-Decrypted-Lore/Variant%20Rules/#minimum-roll-threshold).  All features that cite this rule will be adjusted on a case-by-case basis.
</details>
