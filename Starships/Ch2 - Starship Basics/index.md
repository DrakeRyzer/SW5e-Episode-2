...
```Many of the rules found here are derived and modified from Saga Edition's Basic Starship rules to fit the SW5e system.```
...
It is at the discretion of the Game Masters to determine when a character or party should obtain their first starship using one of the following options as well as the specifics as their cost in time, credits, and favors.
